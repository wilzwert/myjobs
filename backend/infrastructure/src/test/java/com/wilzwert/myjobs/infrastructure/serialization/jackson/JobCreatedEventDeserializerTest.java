...
class JobCreatedEventDeserializerTest {
    ...
    void shouldDeserializeValidJson() throws Exception {
        ...
        // When
        JobCreatedEvent event = objectMapper.readValue(json, JobCreatedEvent.class);
    ...
    void shouldFailDeserializationWhenJobIdIsMissing() {
        ...
        // Then
        assertThrows(Exception.class, () -> objectMapper.readValue(json, JobCreatedEvent.class));
    }
}
