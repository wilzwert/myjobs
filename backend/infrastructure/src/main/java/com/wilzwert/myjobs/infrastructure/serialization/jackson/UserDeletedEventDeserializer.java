...
@Component
public class UserDeletedEventDeserializer extends JacksonIntegrationEventDeserializer<UserDeletedEvent> {

    public UserDeletedEventDeserializer() {
        super(UserDeletedEvent.class);
    }

    @Override
    public UserDeletedEvent deserialize(JsonParser p, DeserializationContext ctxt) throws JacksonException {
        ...
        return new UserDeletedEvent(id, occurredAt, userId);
    }
}