...
@Component
public class AttachmentDeletedEventDeserializer extends JacksonIntegrationEventDeserializer<AttachmentDeletedEvent> {

    public AttachmentDeletedEventDeserializer() {
        super(AttachmentDeletedEvent.class);
    }

    @Override
    public AttachmentDeletedEvent deserialize(JsonParser p, DeserializationContext ctxt) throws JacksonException {
