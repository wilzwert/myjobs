...
import com.wilzwert.myjobs.core.domain.service.metadata.extractor.ExtractedMetadata;
...
public class JsonLdJobMetadataExtractorTest {
    ...
    public void testEmptyJsonExtraction() {
        assertTrue(extractor.getMetadata("").isEmpty());
    }

    @Test
    public void testIncorrectJsonExtraction() {
        assertTrue(extractor.getMetadata("this is not json").isEmpty());
    }

    @Test
    public void testNotJsonLdExtraction() {
        assertTrue(extractor.getMetadata("{\"field\":\"value\"}").isEmpty());
    }
    ...
    public void testNotJobPostingExtraction() throws IOException {
        ...
        assertTrue(extractor.getMetadata(html ).isEmpty());
    }
    ...
    public void testWithNoSalaryExtraction() throws IOException {
        ...
        ExtractedMetadata expectedMetadata = new ExtractedMetadata.Builder()
        ...
        extractor.getMetadata(html).ifPresentOrElse(
