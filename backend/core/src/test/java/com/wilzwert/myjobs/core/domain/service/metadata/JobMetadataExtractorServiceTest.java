...
public class JobMetadataExtractorServiceTest {
    @Mock
    private HtmlFetcherService fetcherService;

    @Mock
    private JobMetadataExtractor metadataExtractor;
    ...
    @BeforeEach
    void setUp() {
        /*HtmlFetcherService htmlFetcherService = mock(HtmlFetcherService.class);
        JobMetadataExtractor jobMetadataExtractor = mock(JobMetadataExtractor.class);
        jobMetadataExtractorService = new JobMetadataExtractorService(htmlFetcherService, List.of(jobMetadataExtractor));*/
        jobMetadataExtractorService = new JobMetadataExtractorService(fetcherService, List.of(metadataExtractor));
    }

    @Test
    public void testGetDomainFromInvalidUrl() {
        assertThrows(MalformedUrlException.class, () -> jobMetadataExtractorService.getDomainFromUrl("not_an_url"));
    }

    @Test
    public void testGetDomainFromIncompatibleUrl() {
        assertThrows(MalformedUrlException.class, () -> jobMetadataExtractorService.getDomainFromUrl("ftp://my.ftp.example.com"));
    }

    @Test
    public void testGetDomainFromUrlWithoutSubdomain() {
        assertEquals("example.com", jobMetadataExtractorService.getDomainFromUrl("http://example.com"));
    }

    @Test
    public void testGetDomainFromUrlWithOneSubdomain() {
        assertEquals("example.com", jobMetadataExtractorService.getDomainFromUrl("https://www.example.com"));
    }

    @Test
    public void testGetDomainFromUrlWithMultipleSubdomain() {
        assertEquals("example.com", jobMetadataExtractorService.getDomainFromUrl("https://w3.www.fr.example.com"));
    }
    ...
    public void testEmptyHtmlExtraction() {
        ...
        assertEquals(expectedJobMetadata, jobMetadataExtractorService.extractMetadata("http://example.com"));
    }
    ...
    public void testCompatibleHtmlExtraction() throws IOException {
        ...
        when(metadataExtractor.extractJobMetadata(anyString())).thenReturn(Optional.of(new JobMetadata.Builder()
